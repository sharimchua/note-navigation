...
import { PIANO_KEYS, getNoteColor, getNoteChroma } from "@/lib/music-engine";
      ...
      >
        ...
        {whiteKeys.map((key, i) => {
          ...
          return (
            <div
              key={key.midi}
              className={`absolute top-0 bottom-0 border border-border/50 cursor-pointer transition-all duration-150 rounded-b-sm
